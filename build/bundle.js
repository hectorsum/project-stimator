var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	let t10;
    	let td1;
    	let t11_value = /*formatter*/ ctx[2].format(/*total*/ ctx[1]) + "";
    	let t11;
    	...
    	return {
    		c() {
    			...
    			thead.innerHTML = `<tr class="svelte-l4pkbt"><th>Material</th> 
      <th>Price</th> 
      <th></th></tr>`;
    			...
    			t11 = text(t11_value);
    			attr(td1, "colspan", "2");
    			attr(tr1, "class", "svelte-l4pkbt");
    			attr(table, "class", "primary svelte-l4pkbt");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*total*/ 2) set_data(t1, /*total*/ ctx[1]);

    			if (dirty & /*edit, materials, remove, formatter*/ 29) {
    				each_value = /*materials*/ ctx[0];
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, tbody, destroy_block, create_each_block, t8, get_each_context);
    			}

    			if (dirty & /*total*/ 2 && t11_value !== (t11_value = /*formatter*/ ctx[2].format(/*total*/ ctx[1]) + "")) set_data(t11, t11_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "float-right svelte-1qp7j1f");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Project Stimator";
    			t1 = space();
    			create_component(form.$$.fragment);
    			t2 = space();
    			create_component(table.$$.fragment);
    			attr(main, "class", "svelte-chkr2a");
    		},
    		m(target, anchor) {
